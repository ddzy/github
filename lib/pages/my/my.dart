                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: Html(
                            data: '${parsedUser.status.emojiHTML.replaceAll('<div>', '').replaceAll('</div>', '')}${parsedUser.status.message}',
                          ),
                        ),
                        Container(
                          alignment: Alignment.centerLeft,
                          ...
                          child: Row(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(left: 6),
                                child: Text(
                                  parsedUser.isDeveloperProgramMember ? '开发者计划成员' : '',
                                  style: const TextStyle(),
                                ),
                              ),
                            ],
                              ...
                              Padding(
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    ...
                                    children: [
                                      TextSpan(
                                        text: '${parsedUser.followers.totalCount}',
                                        style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                        ),
                                      ),
                                      ...
                                      const TextSpan(text: ' · '),
                                      TextSpan(
                                        text: '${parsedUser.following.totalCount}',
                                        style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                        ),
                                      ),
                          ...
                          child: Material(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Container(
                                  width: 250,
                                  margin: index == 0 ? const EdgeInsets.all(0) : const EdgeInsets.only(left: 20),
                                  decoration: BoxDecoration(
                                    border: Border.all(
                                      color: Colors.grey[200]!,
                                    ),
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Icon(
                                                  ...
                                                  color: Color(
                                                    int.parse(
                                                      item.primaryLanguage.color.replaceAll(
                                                        '#',
                                                        '0xff',
                                                      ),
                                                    ),
                      ...
                      child: Column(
                        children: [
                          ListTile(
                            ...
                            trailing: Text('${parsedUser.repositories.totalCount}'),
                            onTap: () {},
                          ),
                          ListTile(
                            leading: Container(
